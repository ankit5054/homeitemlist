          ...
          return (
            ...
            >
              ...
              <div style={{
                display: 'flex',
                alignItems: 'center',
                gap: window.innerWidth <= 1024 ? '20px' : '8px'
              }}>
                <select
                  value={sel.quantity}
                  onChange={(e) => onQuantityChange(itemName, parseFloat(e.target.value))}
                  style={{
                    padding: window.innerWidth <= 1024 ? '24px 28px' : '4px 8px',
                    backgroundColor: '#2d3748',
                    color: '#f7fafc',
                    border: '1px solid #4a5568',
                    borderRadius: '4px',
                    fontSize: window.innerWidth <= 1024 ? '48px' : '14px',
                    minHeight: window.innerWidth <= 1024 ? '88px' : 'auto'
                  }}
                >
                  {getQuantityOptions(effectiveUnit)}
                </select>
                <span style={{ 
                  color: '#cbd5e0', 
                  fontSize: window.innerWidth <= 1024 ? '48px' : '14px',
